...
public class MainController {
 ...
 public static	List<cart> cartlist = new ArrayList<>();
		...
		boolean kiemtra = true;
			for (user kt : list) {
				if(kt.getUsername().equals(re.getParameter("username"))) {
					...
					t.commit();
					Date date = new Date();
					String from="pkhanh494@gmail.com";
					String to=mailgui;
					String subject="Quên mật khẩu";
					String body="Bạn đã báo quên mật khẩu vào "+date+"  mật khẩu mới của bạn là "+matkhaumoi+"\n Nếu bạn không thực hiện yêu cầu trên , vui lòng liên hệ quản trị viên để biết thêm chi tiết";
					try {
	...
	public String quen(ModelMap model, @ModelAttribute("User") user us) {
		return "forgetpass";
	}
