...
<head>
<meta charset="utf-8">
<title>Khanh_Thai</title>
<link rel="icon" type="image/x-icon" href="https://i.pinimg.com/originals/25/40/9e/25409e9b8b3af031fa17a6a510669b1c.jpg">
...
<body>
	<header>
		<div class="container">
			<div class="logo">
				<a href=""><img
					src=" ${pageContext.request.contextPath}/resources/img/logo/shoplogo.jpg" alt=""></a>
			</div>
			<div class="contener1">
					<ul class="navbar">
                ...
                <div class="navbar-right">
                    <div class="search">
                        <input class="ip-search" placeholder="Tim kiem"/>
	...
	<div class="container-dangki">
            ...
            <div class="sign-up-content">
                <img src=${pageContext.request.contextPath}/resources/img/logo/shoplogo.jpg alt="">
                <h2>${tb}</h2>
                <h1>Đăng Kí</h1>
    ...
    <footer>
        <div class="footer-cont">
            ...
            <ul>
                Liên hệ
                <li><a href="">Email : pkhanh494@gmail.com</a></li>
        ...
        <h1>Copyright © 2022 Khanh_Thai. All rights reserved.</h1>
    </footer>
</body>
<script>
    // Get the modal
